...
_lr_productions = [
  ...
  ('start -> ISNUMBER isnumber','start',2,'p_start','compile.py',148),
  ('start -> STATE state','start',2,'p_start','compile.py',149),
  ('lang -> premises MINUS MINUS conclusion','lang',4,'p_lang','compile.py',155),
  ('lang -> MINUS MINUS conclusion','lang',3,'p_lang','compile.py',156),
  ('premises -> statement','premises',1,'p_premises','compile.py',164),
  ('statement -> statement COMA statement','statement',3,'p_statement1','compile.py',170),
  ('statement -> exp symb term','statement',3,'p_statement2','compile.py',177),
  ('statement -> exp symb VAR','statement',3,'p_statement2','compile.py',178),
  ('statement -> exp IN NAME','statement',3,'p_statement3','compile.py',185),
  ('exp -> exp COMA exp','exp',3,'p_exp1','compile.py',192),
  ('exp -> exp SEMICOLON exp','exp',3,'p_exp1','compile.py',193),
  ('exp -> NAME OP exp CP','exp',4,'p_exp2','compile.py',200),
  ('exp -> term','exp',1,'p_exp3','compile.py',207),
  ('exp -> VAR','exp',1,'p_exp3','compile.py',208),
  ('term -> NUM','term',1,'p_term','compile.py',215),
  ('term -> boolean','term',1,'p_term','compile.py',216),
  ('term -> list','term',1,'p_term','compile.py',217),
  ('list -> OSB exp CSB','list',3,'p_list1','compile.py',224),
  ('list -> INF exp SUP','list',3,'p_list1','compile.py',225),
  ('list -> OSB CSB','list',2,'p_list2','compile.py',232),
  ('symb -> EQUAL EQUAL','symb',2,'p_symb','compile.py',239),
  ('symb -> INF EQUAL','symb',2,'p_symb','compile.py',240),
  ('symb -> SUP EQUAL','symb',2,'p_symb','compile.py',241),
  ('symb -> INF','symb',1,'p_symb','compile.py',242),
  ('symb -> SUP','symb',1,'p_symb','compile.py',243),
  ('symb -> MINUS SUP','symb',2,'p_symb','compile.py',244),
  ('conclusion -> exp MINUS SUP exp','conclusion',4,'p_conclusion1','compile.py',251),
  ('conclusion -> list ins_exp MINUS SUP list','conclusion',5,'p_conclusion2','compile.py',258),
  ('ins_exp -> NAME','ins_exp',1,'p_ins_exp','compile.py',265),
  ('ins_exp -> exp','ins_exp',1,'p_ins_exp','compile.py',266),
  ('boolean -> TRUE','boolean',1,'p_boolean','compile.py',273),
  ('boolean -> FALSE','boolean',1,'p_boolean','compile.py',274),
  ('check -> lang','check',1,'p_check','compile.py',287),
  ('split -> s_exp','split',1,'p_split','compile.py',301),
  ('s_exp -> s_exp COMA s_exp','s_exp',3,'p_s_exp1','compile.py',308),
  ('s_exp -> s_exp SEMICOLON s_exp','s_exp',3,'p_s_exp1','compile.py',309),
  ('s_exp -> NAME OP exp CP','s_exp',4,'p_s_exp2','compile.py',316),
  ('s_exp -> term','s_exp',1,'p_s_exp3','compile.py',323),
  ('s_exp -> VAR','s_exp',1,'p_s_exp3','compile.py',324),
  ('token -> t_exp','token',1,'p_token','compile.py',338),
  ('token -> t_list','token',1,'p_token','compile.py',339),
  ('token -> t_statement','token',1,'p_token','compile.py',340),
  ('token -> t_state_ins','token',1,'p_token','compile.py',341),
  ('t_exp -> t_exp COMA t_exp','t_exp',3,'p_t_exp1','compile.py',347),
  ('t_exp -> t_exp SEMICOLON t_exp','t_exp',3,'p_t_exp1','compile.py',348),
  ('t_exp -> NAME OP t_exp CP','t_exp',4,'p_t_exp2','compile.py',355),
  ('t_exp -> t_term','t_exp',1,'p_t_exp3','compile.py',362),
  ('t_exp -> VAR','t_exp',1,'p_t_exp3','compile.py',363),
  ('t_term -> NUM','t_term',1,'p_t_term','compile.py',370),
  ('t_term -> boolean','t_term',1,'p_t_term','compile.py',371),
  ('t_term -> t_list','t_term',1,'p_t_term','compile.py',372),
  ('t_list -> OSB t_exp CSB','t_list',3,'p_t_list1','compile.py',379),
  ('t_list -> INF t_exp SUP','t_list',3,'p_t_list1','compile.py',380),
  ('t_list -> OSB CSB','t_list',2,'p_t_list2','compile.py',387),
  ('t_list -> INF SUP','t_list',2,'p_t_list2','compile.py',388),
  ('t_statement -> t_statement COMA t_statement','t_statement',3,'p_t_statement1','compile.py',395),
  ('t_statement -> t_exp symb term','t_statement',3,'p_t_statement2','compile.py',402),
  ('t_statement -> t_exp symb VAR','t_statement',3,'p_t_statement2','compile.py',403),
  ('t_statement -> t_exp IN NAME','t_statement',3,'p_t_statement3','compile.py',410),
  ('t_state_ins -> t_list t_ins_exp','t_state_ins',2,'p_t_state_ins','compile.py',417),
  ('t_ins_exp -> t_ins','t_ins_exp',1,'p_t_ins_exp','compile.py',424),
  ('t_ins_exp -> t_exp','t_ins_exp',1,'p_t_ins_exp','compile.py',425),
  ('t_ins -> NAME','t_ins',1,'p_t_ins','compile.py',432),
  ('isnumber -> NUM','isnumber',1,'p_isnumber','compile.py',447),
  ('calc -> c_exp','calc',1,'p_calc','compile.py',463),
  ('calc -> c_condition','calc',1,'p_calc2','compile.py',470),
  ('c_condition -> c_exp comparator c_exp','c_condition',3,'p_condition','compile.py',477),
  ('comparator -> EQUAL EQUAL','comparator',2,'p_comparator','compile.py',483),
  ('comparator -> SUP','comparator',1,'p_comparator','compile.py',484),
  ('comparator -> SUP EQUAL','comparator',2,'p_comparator','compile.py',485),
  ('comparator -> INF','comparator',1,'p_comparator','compile.py',486),
  ('comparator -> INF EQUAL','comparator',2,'p_comparator','compile.py',487),
  ('c_exp -> NAME OP c_exp CP','c_exp',4,'p_exp_operator','compile.py',493),
  ('c_exp -> c_exp COMA c_exp','c_exp',3,'p_exp_more','compile.py',500),
  ('c_exp -> c_exp SEMICOLON c_exp','c_exp',3,'p_exp_more','compile.py',501),
  ('c_exp -> NUM','c_exp',1,'p_exp_int','compile.py',507),
  ('c_exp -> boolean','c_exp',1,'p_exp_int','compile.py',508),
  ('c_exp -> list','c_exp',1,'p_exp_list','compile.py',514),
  ('c_list -> OSB c_morelist CSB','c_list',3,'p_exp_list1','compile.py',520),
  ('c_morelist -> NUM COMA c_morelist','c_morelist',3,'p_exp_list2','compile.py',526),
  ('c_morelist -> NUM SEMICOLON c_morelist','c_morelist',3,'p_exp_list2','compile.py',527),
  ('c_morelist -> NUM','c_morelist',1,'p_exp_list3','compile.py',533),
  ('c_list -> OSB CSB','c_list',2,'p_exp_list4','compile.py',539),
  ('c_list -> INF c_morelist SUP','c_list',3,'p_exp_list5','compile.py',545),
  ('state -> st_list st_ins_exp','state',2,'p_state','compile.py',558),
  ('st_ins_exp -> st_ins','st_ins_exp',1,'p_st_ins_exp1','compile.py',566),
  ('st_ins_exp -> st_exp','st_ins_exp',1,'p_st_ins_exp2','compile.py',572),
  ('st_ins -> NAME','st_ins',1,'p_st_ins','compile.py',579),
  ('st_exp -> NAME OP t_exp CP','st_exp',4,'p_st_exp','compile.py',586),
  ('st_list -> OSB s_exp CSB','st_list',3,'p_st_list','compile.py',598),
  ('st_list -> INF s_exp SUP','st_list',3,'p_st_list','compile.py',599),
]
